# Paper Dashboard 2 Frontend Preset For Laravel Framework 5.5 and Up

Paper Dashboard 2 Frontend Preset For Laravel Framework 5.5 and Up

*Current version*: Paper Dashboard 2 v1.0.10. More info at https://www.creative-tim.com/product/paper-dashboard-2-laravel.
...
3. Run `php artisan preset paper` command to install the Paper Dashboard 2 preset. This will install all the necessary assets and also the custom auth views, it will also add the auth route in `routes/web.php`
...
2. [Download an archive](https://github.com/laravel-frontend-presets/paper/archive/master.zip) of the repo and unzip it
3. Copy and paste **paper-master** folder in presets (created in step 1) and rename it to **paper**
...
[MIT License](https://github.com/laravel-frontend-presets/paper/blob/master/license.md).

## Screen shots

![Paper Dashboard 2 Login](/screens/Login.png)

![Paper Dashboard 2 Dashboard](/screens/Dashboard.png)

![Paper Dashboard 2 Users](/screens/Users.png)

![Paper Dashboard 2 Profile](/screens/Profile.png)
